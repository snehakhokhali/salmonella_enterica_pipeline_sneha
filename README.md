...
# Building DAG of jobs...                                                                                                                                                                                          #  MissingRuleException:                                                                                                                                                                                           #   No rule to produce assembly_stats (if you use input functions make sure that they don't raise unexpected exceptions).
